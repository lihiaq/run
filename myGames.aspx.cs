...
public partial class _Default : System.Web.UI.Page
{
    ...
    int charCount = 0;
    string UserID = "1"; // NEED TO MAKE DYNAMIC VAR**********************************************************************

    protected void Page_Init(object sender, EventArgs e)
    {
        SqlDataSource1.SelectCommand = "SELECT * FROM games WHERE userID = " + UserID + " order by ID DESC";   //connect GridView to Access
    ...
    {
        cretateGameBtn.Enabled = false; // create game button will be disabled
        PopUpbackground.Visible = false; // remove some screens with any postback
